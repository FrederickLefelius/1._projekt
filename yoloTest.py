# Test fil for YOLO AI funktionalitet med live kamera feed
# Kør denne fil direkte på Pi'en for at teste om YOLO virker korrekt
...
try:
    while True:
        # Hent live frame til visning
        live_feed()
 
        # Hent behandlet frame til YOLO
